...
const ProductTemplate: React.FC<ProductTemplateProps> = ({ product }) => {
  return (
    <>
      <div className="content-container flex flex-col small:flex-row gap-2 small:items-start py-6 relative">
      <div className="flex flex-col gap-2 items-center w-full">
        <div className="block w-full relative">
          <ImageGallery images={product?.images || []} />
        </div>
        <div className="flex flex-col small:sticky small:top-48 small:py-0 w-full py-8 small:px-14 gap-y-12">
